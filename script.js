let readMore = false; //assign user still doesn't click the read more button
let text =
...
document.getElementById("btn-read").addEventListener("click", function () {
  if (readMore == false) {  //if user wants to read more...
    readMore = !readMore;
  ...
  else { //if user wants to show less...
    readMore = !readMore;
    document.getElementById("text").innerText = text.substring(0, 208);//shrink the text
